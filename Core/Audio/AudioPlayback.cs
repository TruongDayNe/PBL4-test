...
namespace RealTimeUdpStream.Core.Audio
{
    ...
    public class AudioPlayback : IDisposable
    {
        ...
        private const int MAX_BUFFER_DURATION_MS = 600; // 5 seconds maximum buffer
        private const int MIN_BUFFER_DURATION_MS = 300; // 5 seconds minimum before starting playback (high stability)
