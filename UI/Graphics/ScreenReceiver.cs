...
namespace UI.Graphics
{
    ...
    public class ScreenReceiver : IDisposable
    {
        ...
        // Dictionary để lưu trữ các gói tin (chunk) của một khung hình đang được tái hợp.
        // Key: SequenceNumber (ID của khung hình), Value: Danh sách các gói tin con đã nhận
